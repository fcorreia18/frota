...
class CompaniesComponent extends Component
{
    ...
    {
        return view('livewire.admin.companies.index', ['companies' => Company::search($this->searchField, $this->search)->with('group')->orderBy($this->sortField, $this->sortDirection)->paginate(4),])->layout("layouts.app.base");
    }
